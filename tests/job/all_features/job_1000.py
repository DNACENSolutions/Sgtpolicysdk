...
Run this job from parent directory:
    pyats run job tests/job/all_features/job_1000.py
...
testinputs=os.path.join(BASE_RUN_PATH,'tests/testinputs/testinputs_1000_1658389246.json')
...
def main():
    ...
    job_list=[]
    script_name1 = os.path.join(BASE_RUN_PATH,'tests/testscripts/sgttest/sgttest.py')
    script_name2 = os.path.join(BASE_RUN_PATH,'tests/testscripts/contracttest/contracttest.py')
    script_name3 = os.path.join(BASE_RUN_PATH,'tests/testscripts/policytest/policytest.py')
    ...
    if str(task1.result) != "passed" or str(task2.result) != "passed":
        print("Some test case failed. Not executing policy testcases")
    else:
