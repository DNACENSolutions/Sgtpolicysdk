...
Run this job from parent directory:
    pyats run job tests/job/all_features/job_1000_policytest_create.py
...
def main():
    ...
    job_list=[]
    script_name = os.path.join(BASE_RUN_PATH,'tests/testscripts/policytest/policytest_create.py')
