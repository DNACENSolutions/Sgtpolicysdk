'''
job_1000_sgttest_create_default.py
...
Run this job from parent directory:
    pyats run job tests/job/all_features/job_1000_sgttest_create_default.py
...
def main():
    ...
    job_list=[]
    script_name = os.path.join(BASE_RUN_PATH,'tests/testscripts/sgttest/sgttest_create_default.py')
