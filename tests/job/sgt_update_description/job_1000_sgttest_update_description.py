'''
job_1000_sgttest_update_description.py
...
Run this job from parent directory:
    pyats run job tests/job/all_features/job_1000_sgttest_update_description.py
...
def main():
    ...
    job_list=[]
    script_name = os.path.join(BASE_RUN_PATH,'tests/testscripts/sgttest/sgttest_update_description.py')
