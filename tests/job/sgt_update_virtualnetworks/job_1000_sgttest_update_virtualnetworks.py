'''
job_1000_sgttest_update_virtualnetworks.py

This job is to launch the script: sgttest.py, contracttest.py, sgttests.py
This should be run in your python environment with pyats installed. 

Run this job from parent directory:
    pyats run job tests/job/all_features/job_1000_sgttest_update_virtualnetworks.py
...
def main():
    ...
    job_list=[]
    script_name = os.path.join(BASE_RUN_PATH,'tests/testscripts/sgttest/sgttest_update_virtualnetworks.py')
