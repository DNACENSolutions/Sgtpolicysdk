...
class Test_update_sgts_virtualnetworks(aetest.Testcase):
    @aetest.test
    def test_update_virtualnetworks_sgts(self, steps, dnac_obj):
        ...
        logging.info("Deploy after Test update sgts Virtual Network")
