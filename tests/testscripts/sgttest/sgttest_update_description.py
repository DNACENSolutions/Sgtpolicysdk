...
class Test_update_sgts_description(aetest.Testcase):
    @aetest.test
    def test_update_sgts_description(self, steps, dnac_obj):
        ...
        logging.info("Deploy after Test update sgt description")
