...
class Test_update_accesscontract_data(aetest.Testcase):
    @aetest.test
    def test_update_accesscontracts_data(self, steps, dnac_obj):
            ...
            with steps.start("Updating Access Contract {} data".format(ac_data\
                ...
                if not dnac_obj.accesscontracts.updateAccessContract(ac_data\
                    ...
                    step.passed("Updated Access Contract data: {}".format(ac_data\
                                                                   ["contract_name"]))       
        logging.info("Deploy after Test update contract data")
